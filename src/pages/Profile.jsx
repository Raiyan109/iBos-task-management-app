...
const Profile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if ((!userName || nameResult !== userName) && (!userPhoto || photo !== userPhoto)) { // Check if the name needs to be updated
            ...
            await updateProfile(auth.currentUser, {
                displayName: name, photoURL: URL.createObjectURL(photo)
            }).then(() => {
    ...
    return (
        <div>
            ...
            <section className="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-20">
                ...
                <div className="m-5">
                    <img className="rounded-full w-28 h-28 object-cover" src={`${user?.photoURL ? user?.photoURL : avatar}`} alt="" />
                </div>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" >Bio</label>
